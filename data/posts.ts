export const posts: Array<{
...
}> = [
  {
    ...
    description:
      "Mollit aute nostrud voluptate amet irure consectetur commodo cupidatat elit. Non ut dolor nulla dolor duis.",
  ...
  },
  {
    ...
    description:
      "Culpa laboris aliquip ea consectetur mollit ea ipsum sint qui culpa laboris dolor adipisicing proident do nulla tempor cupidatat  elit.",
  ...
  },
  {
    ...
    description:
      "Ea qui quis ad mollit enim in nostrud officia nisi id aute anim non. Adipisicing aliqua amet adipisicing consequat eiusmod anim exercitation proident.",
